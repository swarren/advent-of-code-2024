...
def check_xmas(grid, row, col):
    ...
    dir1 = [(-1, -1), (1, 1)]  # top-left -> bottom-right and bottom-left -> top-right
    dir2 = [(1, -1), (-1, 1)]  # bottom-left -> top-right and top-right -> bottom-left

    # Check for "MAS" or "SAM" in the diagonals
    def check_diagonal(word, row, col, dir1, dir2):
        # Unpack direction tuples
        m1_row, m1_col = row + dir1[0][0], col + dir1[0][1]  # top-left direction
        s1_row, s1_col = row + dir2[0][0], col + dir2[0][1]  # bottom-right direction
        m2_row, m2_col = row + dir2[1][0], col + dir2[1][1]  # bottom-left direction
        s2_row, s2_col = row + dir1[1][0], col + dir1[1][1]  # top-right direction
